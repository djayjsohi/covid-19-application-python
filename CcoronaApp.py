...
############################################################  Buttons
InHtml = Button(root,text='Html',bg='blue',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='blue',activeforeground='white',
...
InCsv = Button(root,text='Csv',bg='orange',font=('arial',15,'italic bold'),relief=RIDGE,activebackground='blue',activeforeground='white',
